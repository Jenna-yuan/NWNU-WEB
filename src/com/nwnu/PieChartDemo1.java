...
public class PieChartDemo1 {
	public static void main(String[] args) {
		...
		JFreeChart chart = ChartFactory.createPieChart3D("全校疫情信息填报数据统计", data, true, false, false);
		...
		JFrame frame = new JFrame("全校疫情信息填报数据统计");
	...
	private static DefaultPieDataset getDataSet() {
		...
		dataset.setValue("提交人数", 2000);
		dataset.setValue("未提交人数", 100);
		return dataset;
	}
}
