...
<div id="center" style="margin-top:80px">
	<div style="margin-left:400px;height:30px">	
		<form id="queryForm" name="queryForm" action="list">	
			...
			<select style="width:40;">
			 ...
			 &emsp;&emsp;疑似状况：
			 <input type="radio" name="favorite5" value="nba" style="margin-left:10px"> 有
			 <input type="radio" name="favorite5" value="nba" style="margin-left:20px"> 无 
